        ...
        <Animated.View entering={FadeInDown.duration(350)} style={styles.lessonMeta}>
          ...
          <View style={styles.lessonInfoRow}>
            <View style={styles.lessonInfo}>
              ...
              <Text style={styles.lessonInfoText}>{lesson.estimatedMinutes} min</Text>
            </View>
            <View style={styles.lessonInfo}>
            ...
            <View style={styles.lessonInfo}>
              ...
              <Text style={styles.lessonInfoText}>{lesson.quizQuestions.length} quiz questions</Text>
            </View>
          </View>
        </Animated.View>
        ...
        <View style={styles.tabRow}>
          {["learn", "practice"].map((t) => (
            <Pressable
              ...
              onPress={() => setTab(t as "learn" | "practice")}
            >
              <Text style={[styles.tabText, tab === t && { color: mod.color }]}>
                {t === "learn" ? "Theory" : "Practice"}
              </Text>
            </Pressable>
          ))}
        </View>
            ...
            {lesson.realWorldExample && (
              <View style={[styles.exampleCard, { borderColor: mod.color + "44" }]}>
                <View style={styles.exampleHeader}>
                  ...
                  <Text style={[styles.exampleLabel, { color: mod.color }]}>Real-World Example</Text>
                </View>
          ...
          <Animated.View entering={FadeIn.duration(250)}>
            {lesson.practiceTask ? (
              <View style={[styles.practiceCard, { borderColor: mod.color + "44" }]}>
                <View style={styles.practiceHeader}>
                  ...
                  <Text style={[styles.practiceLabel, { color: mod.color }]}>Practice Task</Text>
                </View>
                ...
                <View style={styles.practiceTip}>
                  ...
                  <Text style={styles.practiceTipText}>
                    Open Unreal Engine 5 and try this exercise. There's no wrong answer — just explore!
                  </Text>
                </View>
              </View>
            ) : (
              <View style={styles.noPracticeCard}>
                ...
                <Text style={styles.noPracticeText}>
                  Practice for this lesson happens inside Unreal Engine.
                  Review the theory tab and apply it to your project.
                </Text>
              </View>
            )}
            ...
            <View style={[styles.quizPromptCard, { borderColor: mod.color + "33" }]}>
              ...
              <Text style={styles.quizPromptDesc}>
                {lesson.quizQuestions.length} questions on {lesson.title}
              </Text>
              <Pressable
      ...
      <View style={[styles.footer, { paddingBottom: bottomPadding + 10 }]}>
        {!isCompleted ? (
          ...
          >
            ...
            <Text style={styles.completeBtnText}>Mark as Complete (+{lesson.xpReward} XP)</Text>
          </Pressable>
        ) : (
          <View style={styles.completedFooter}>
            ...
            <Pressable
              ...
              onPress={handleStartQuiz}
            >
              <Text style={styles.quizFooterText}>Retake Quiz</Text>
            </Pressable>
          </View>
        )}
      </View>
